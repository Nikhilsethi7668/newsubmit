    ...
    return (
        <div data-scroll data-scroll-speed='-.9' className="first ">
            <div className="main flex w-[100%] h-[100%] items-center">
                ...
                <div className="img border rounded-lg relative top-1/2"><img src="https://lh3.googleusercontent.com/proxy/G9iwWOBBGOjcByltFWjvkr7rp2E_XHL7Mju1-L5yDzpbc3R29Qvl7HVemzhgS8ZLaxNI-Kfa82CNzu_Nvzu_H6GZAwUaHwtkO_UUhy23" alt="" /></div>
            </div>
            ...
            <div className="bottom relative -top-[18vh] flex justify-between items-center ">
                ...
                <div className="right flex items-center  ">
                    <button className='border border-black rounded-full h-[5vh] mx-5 flex items-center justify-center p-5 hover:bg-black hover:text-white'> ForAdmission </button>
